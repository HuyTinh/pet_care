...
public class WebSocketHandler extends TextWebSocketHandler {
    ...
    public void sendMessageRoundRobin(Message message) throws IOException, JMSException, InterruptedException {
            ...
            if (!sessions.isEmpty()) {
                ...
                if (session.isOpen()) {
                    if (message instanceof TextMessage) {
                        ...
                        session.sendMessage(new org.springframework.web.socket.TextMessage((textMessage.getText())));
                    }
                }
